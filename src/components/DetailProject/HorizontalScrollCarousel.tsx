...
const HorizontalScrollCarousel: React.FC<Props> = ({ title, description, cards }) => {
  ...
  return (
    <div ref={targetRef} className="h-[300vh] w-screen bg-gradient-to-b from-gray-300 dark:from-mainColor to-white dark:to-dark-blue">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        <div className="flex gap-[7rem] md:gap-[8.5rem] items-center">
          ...
          >
            <p className="font-main text-4xl">{title}</p>
          ...
          <motion.div
            ...
            <ArrowLinkIcon className="animate-pulse text-mainColor dark:text-white" />
          </motion.div>
        </div>
      </div>
    </div >
